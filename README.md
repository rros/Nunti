...
3. connect your phone and make sure adb can find your device
4. run `npx react-native start` in one terminal
5. run `npx react-native run-android` in the second to build
